...
data class AdConfig (
  ...
  @SerializedName("high_risk_flags"   ) var high_risk_flags   : ArrayList<String> = arrayListOf(),
  ...
  @SerializedName("show_ads"          ) var showAds         : Boolean?          = null,
  @SerializedName("show_ad_level"     ) var show_ad_level     : Int?              = null,
  @SerializedName("nsfw_score"        ) var nsfwScore       : Double?           = null
